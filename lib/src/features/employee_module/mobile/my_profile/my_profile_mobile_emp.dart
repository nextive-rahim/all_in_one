...
class MyProfileEmployeeMobile extends StatefulWidget {
  final Function onLogout;
  const MyProfileEmployeeMobile({super.key, required this.onLogout});

  @override
  State<MyProfileEmployeeMobile> createState() =>
      _MyProfileEmployeeMobileState();
}

class _MyProfileEmployeeMobileState extends State<MyProfileEmployeeMobile> {
  @override
  void initState() {
    // _fetchDummyData();
    super.initState();
            ...
            body: Column(
              children: [
                const StudentAppBarMobile(
                  ...
                  title2: 'Tata Consultancy services pvt. ltd.',
                  isBack: false,
                  searchHintText: '',
                        ...
                        children: [
                              ...
                              Container(
                                ...
                                decoration: ShapeDecoration(
                                  image: DecorationImage(
                                    image:
                                        AssetImage(ImageConstant.profilePicBg),
                                    fit: BoxFit.fill,
                                  ),
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: Padding(
                                padding: const EdgeInsets.only(
                                    left: 30, right: 30, bottom: 44, top: 44),
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    const TextWidget(
                                    ...
                                    const TextWidget(
                                        text:
                                            "${AppStrings.employeeID}858585858",
                                        color: CommonColor.greyColor4,
                                        maxLine: 2,
                                        fontFamily: AppStrings.aeonikTRIAL,
                                        fontWeight: FontWeight.w400,
